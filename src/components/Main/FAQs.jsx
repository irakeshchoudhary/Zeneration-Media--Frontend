...
const FAQs = () => {
    ...
    return (
        <section className="min-h-screen flex flex-col items-center justify-center px-4 py-12 relative z-[10]">
            ...
            <h2 className="md:text-5xl text-3xl font-Gilroy-SemiBold text-white text-center mb-10 leading-tight">
            ...
            <Accordion type="single" collapsible className="w-full max-w-2xl space-y-3">
                {faqs.map((faq, idx) => {
                    ...
                    return (
                        ...
                        >
                            <AccordionTrigger
                                className="flex cursor-pointer items-center justify-between px-6 py-5 text-sm font-['F3'] text-white focus:outline-none transition-colors"
                            ...
                            <div
                                ...
                                className="px-6 text-sm font-['F3'] text-[#b3bdb8] overflow-hidden transition-all duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)]"
                                style={{
                                    maxHeight: isOpen
                                        ? `${contentRefs.current[idx]?.scrollHeight}px`
                                        : "0px",
                                    paddingTop: isOpen ? "4px" : "0px",
                                    // paddingBottom: isOpen ? "36px" : "0px",
            ...
            <div className="mt-4 text-center text-sm text-[#b3bdb8]">
